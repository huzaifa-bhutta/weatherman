...
module Reports
  ...
  def generate_average_report
    ...
    highest_average_list = Array.new
    lowest_average_list = Array.new
    humidity_average_list = Array.new
  ...
  def generate_yearly_report
    dir = get_arguments[2]
    yearly_highest_list = Array.new
    yearly_lowest_list = Array.new
    yearly_humidity_list = Array.new
    get_input_year_filenames.each do |filename|
      file = File.open("#{dir}/#{filename}", 'r')
      monthly_highest = Array.new
      monthly_lowest = Array.new
      monthly_humidity = Array.new
      daily_data = Array.new
      file.each do |line, index|
